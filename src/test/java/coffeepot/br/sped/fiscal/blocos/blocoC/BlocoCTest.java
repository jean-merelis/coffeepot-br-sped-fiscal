...
public class BlocoCTest {
    ...
    static BlocoC instance;

    @BeforeClass
    public static void setUpClass() {

        try {
            Writer fw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("BlocoCTest.txt"), "ISO-8859-1"));
            instance = new BlocoC(fw);
    ...
    @Test
    public void testWriteFileBlocoC() throws Exception {
        try {
            instance.writeIndicadorMovimento(IndicadorMovimento.COM_DADOS);
            testWriteC100();
            testWriteC100();
            instance.writeEncerramentoBloco();
        } finally {
            instance.getWriter().flush();
            //instance.getWriter().close(); está sendo fechado no metodo tearDownClass()
        }
    }

    // @Test
    public void testWriteC100() throws Exception {
    ...
    private List<RegC112> createRegC112List() {
    ...
    private List<RegC113> createRegC113List() {
    ...
    private List<RegC114> createRegC114List() {
    ...
    private List<RegC115> createRegC115List() {
    ...
    private List<RegC116> createRegC116List() {
    ...
    private List<RegC141> createRegC141List() {
    ...
    private List<RegC165> createRegC165List() {
    ...
    private List<RegC171> createRegC171List() {
    ...
    private List<RegC172> createRegC172List() {
    ...
    private List<RegC173> createRegC173List() {
    ...
    private List<RegC174> createRegC174List() {
    ...
    private List<RegC176> createRegC176List() {
    ...
    private List<RegC197> createRegC197List() {
